<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DsChucVu.ascx.cs" Inherits="HOPKHONGGIAY.DsChucVu" %>
            ...
            <asp:DataGrid DataKeyField="CV_ID" runat="server" ID="dgDanhSach" OnInit="dgDanhSach_Init" AutoGenerateColumns="False" OnPageIndexChanged="dgDanhSach_PageIndexChanged" AllowPaging="True" AllowCustomPaging="False" OnItemCreated="dgDanhSach_ItemCreated"
                ...
                <Columns>
                 ...
                 <%--   <asp:TemplateColumn HeaderText="Sửa" Visible="true">
                        ...
                        <ItemStyle Width="5%" HorizontalAlign="Center" />
                        <ItemTemplate>
                            <a onserverclick="dgDanhSach_Sua" title="Cập nhật thông tin chức vụ" class="icon-sua" href='<%# Eval("CV_ID").ToString() %>' oncontextmenu="return false" runat="server"></a>
                        </ItemTemplate>
                    </asp:TemplateColumn>--%>
