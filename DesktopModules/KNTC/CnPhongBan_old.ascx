<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CnPhongBan_old.ascx.cs" Inherits="HOPKHONGGIAY.CnPhongBan" %>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="col-sm-6 col-md-6 col-lg-6 pd-l30 pd-r30">
                                <div class="form-group mr-t10">
                                    <label class="col-sm-3 control-label pd-r0" runat="server" id="labelTenPhongBan">Tên phòng ban</label>
                                    <div class="col-sm-9 col-md-9 col-lg-9">
                                        <asp:TextBox ID="textTenPhongBan" runat="server" CssClass="form-control requirements" MaxLength="500" />
                                    </div>
                                </div>                                                                                                           
                            </div>
