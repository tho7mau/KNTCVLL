<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TK_KETQUATOCAO.ascx.cs" Inherits="KNTC.TK_KETQUATOCAO" %>
            ...
            <div class="container-fluid">
                <div class="card card-table-master">
                    <div class="card-header sticky">
                        <h3 class="card-title">Thống kê kết quả xử lý đơn tố cáo</h3>
