<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TK_KETQUAPAKN.ascx.cs" Inherits="KNTC.TK_KETQUAPAKN" %>
            ...
            <div class="container-fluid">
                <div class="card card-table-master">
                    <div class="card-header sticky">
                        <h3 class="card-title">Thống kê kết quả xử lý đơn phản ánh kiến nghị</h3>
