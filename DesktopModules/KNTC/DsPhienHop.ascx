<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DsPhienHop.ascx.cs" Inherits="HOPKHONGGIAY.DsPhienHop" %>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body" style="margin-left: 10px; margin-right: 10px">
                       <asp:Label runat="server" ID="lblNoiDungCanChinhSua"/>
                    </div>
                    <div class="modal-footer">
            ...
            <div class="form-inline">
                <div class="col-right mr-b6">
                    ...
                    <asp:DropDownList Visible="false" ID="ddlistTrangThai" runat="server" OnSelectedIndexChanged="btnSearch_Click" AutoPostBack="true" CssClass="form-control slPhongBan" AppendDataBoundItems="true">
                        ...
                        <asp:ListItem Value="0" Text="Dự thảo" />
                ...
                <div class="col-left" runat="server">
                    ...
                    <div style="display: none;">
                        <asp:LinkButton ID="btn_Xoa" OnClientClick="return getConfirmation(this, 'THÔNG BÁO','Bạn chắc chắn muốn xóa những phiên họp đã chọn?');" CausesValidation="false" Visible="true" runat="server" CssClass="btn-default btn-sm none-radius  btn min-width-100 mr-t3 mr-b3" OnClick="btn_Xoa_Click"><i class=""></i> Xóa</asp:LinkButton>
                    </div>
                </div>
            </div>
        </asp:Panel>
            ...
            <asp:DataGrid DataKeyField="PHIENHOP_ID" runat="server" ID="dgDanhSach" OnInit="dgDanhSach_Init" AutoGenerateColumns="False" OnPageIndexChanged="dgDanhSach_PageIndexChanged" AllowPaging="True" AllowCustomPaging="False" OnItemCreated="dgDanhSach_ItemCreated"
                ...
                <Columns>
                    ...
                    <asp:TemplateColumn HeaderText="Tiêu đề" HeaderStyle-HorizontalAlign="Left" SortExpression="TIEUDE">
                        <ItemStyle HorizontalAlign="Left" />
                        <ItemTemplate>
                            <a id="dgChiTiet" onserverclick="dgDanhSach_Sua" title="Thông tin phiên họp" href='<%# Eval("PHIENHOP_ID").ToString() %>' oncontextmenu="return false" runat="server"><%# DataBinder.Eval(Container, "DataItem.TIEUDE") %></a>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    ...
                    <asp:BoundColumn SortExpression="THOIGIANBATDAU" HeaderText="Thời gian bắt đầu" DataField="THOIGIANBATDAU" DataFormatString="{0:dd/MM/yyyy HH:mm}" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>

                    <asp:BoundColumn SortExpression="THOIGIANKETTHUC" HeaderText="Thời gian kết thúc" DataField="THOIGIANKETTHUC" DataFormatString="{0:dd/MM/yyyy HH:mm}" ItemStyle-HorizontalAlign="Center"></asp:BoundColumn>

                    <asp:TemplateColumn HeaderText="Trạng thái" Visible="false" HeaderStyle-HorizontalAlign="Left" SortExpression="TRANGTHAI">
                        <ItemStyle HorizontalAlign="Left" />
                        <ItemTemplate>
                                <%# DataBinder.Eval(Container, "DataItem.TRANGTHAI").ToString() == "0" ? "Dự thảo":
                                    (DataBinder.Eval(Container, "DataItem.TRANGTHAI").ToString() == "1" ? "Duyệt" :
                                    (DataBinder.Eval(Container, "DataItem.TRANGTHAI").ToString() == "2"? "Công bố" : "")) %>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                   ...
                   <%-- <asp:TemplateColumn HeaderText="Chọn phòng" Visible="false">
                      ...
                      <asp:TemplateColumn ItemStyle-Width="15%" HeaderText="Trạng thái" Visible="true" HeaderStyle-HorizontalAlign="Left">
                        <ItemStyle HorizontalAlign="Left" />
                        <ItemTemplate>

                          <span style='<%# DataBinder.Eval(Container, "DataItem.TRANGTHAI").ToString() == "0" ?"":"display:none"%>'> Dự thảo</span>

                            <a onserverclick="showNoiDungYeuCauChinhSua" href='<%# DataBinder.Eval(Container,"DataItem.PHIENHOP_ID")%>' runat="server"><span style='<%# DataBinder.Eval(Container, "DataItem.TRANGTHAI").ToString() == "6" ?"":"display:none"%>'>Yêu cầu chỉnh sửa <i class="icofont-ui-messaging color-yellow mr-l5"></i></span> </a>
                        </ItemTemplate>
                      </asp:TemplateColumn>


                    <asp:TemplateColumn HeaderText="Gửi duyệt">
                        <ItemStyle HorizontalAlign="Center" Width="10%" />
                        <ItemTemplate>
                            <a id="lnkKichHoat" href='<%# DataBinder.Eval(Container,"DataItem.PHIENHOP_ID") %>' onclick="return getConfirmation(this, 'THÔNG BÁO','Bạn muốn gửi duyệt phiên họp này?');" onserverclick="ThayDoiTrangThai" runat="server">
                                <i class="icofont-send-mail fz25 t-organ" ></i>
                            </a>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                    ...
                    <%--   <asp:TemplateColumn HeaderText="Sửa" Visible="false">
                        ...
                        <ItemStyle Width="5%" HorizontalAlign="Center" />
                        <ItemTemplate>
                            <a onserverclick="dgDanhSach_Sua" title="Cập nhật thông tin phiên họp" class="icon-sua" href='<%# Eval("PHIENHOP_ID").ToString() %>' oncontextmenu="return false" runat="server"></a>
                        </ItemTemplate>
                    </asp:TemplateColumn>--%>
