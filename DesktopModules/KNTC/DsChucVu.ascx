<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DsChucVu.ascx.cs" Inherits="KNTC.DsChucVu" %>
                    ...
                    <div class="card card-table-master">
                                                ...
                                                <ul class="navbar-nav">
                                                    <li class="nav-item dropdown dropdown-filter">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right" role="menu" style="">
                                                            <a href="#" class="dropdown-item" data-option="CHUCVU.TENCHUCVU" data-type="normal" data-title="Mã đơn vị"><i class="icofont-check"></i>Tên chức vụ</a>
                                                            <a href="#" class="dropdown-item" data-option="CHUCVU.MOTA" data-type="normal"><i class="icofont-check"></i>Mô tả</a>                                                            
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="table-content p-0">
                                <asp:DataGrid DataKeyField="CV_ID" runat="server" ID="dgDanhSach" AutoGenerateColumns="False" BorderWidth="0" AutoPostback="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn HeaderText="CV_ID" DataField="CV_ID" Visible="false" HeaderStyle-CssClass="sticky">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle />
                                        </asp:BoundColumn>
                                        <asp:TemplateColumn HeaderText="Tên chức vụ" ItemStyle-Width="50%" HeaderStyle-HorizontalAlign="Left" SortExpression="TENCHUCVU" HeaderStyle-CssClass="sticky">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <a onserverclick="dgDanhSach_Sua" title="Cập nhật đơn vị" href='<%# Eval("CV_ID").ToString() %>' oncontextmenu="return false" runat="server"><%# DataBinder.Eval(Container, "DataItem.TENCHUCVU") %></a>
                                            </ItemTemplate>
                                        </asp:TemplateColumn> 
