<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TK_SOTIEPDAN.ascx.cs" Inherits="KNTC.TK_SOTIEPDAN" %>
            ...
            <div class="container-fluid">
                <div class="card card-table-master">
                    <div class="card-header sticky">
                        <h3 class="card-title">Sổ tiếp dân</h3>
                        ...
                        <div class="card-body p-0">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            <label class="col-lg-3 col-form-label">Loại đối tượng</label>
                                            <div class="col-lg-9">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            <label  class="col-lg-3 col-form-label">Loại tiếp dân</label>
                                            <div class="col-lg-9">
                                                <asp:DropDownList ID="ddlistLoai" AutoPostBack="true" runat="server" CssClass="form-control select2bs4">
                                                    <asp:ListItem Value="0" Text="Tất cả" Selected="True"></asp:ListItem>
                                                    <asp:ListItem Value="1" Text="Có đơn"></asp:ListItem>
                                                    <asp:ListItem Value="2" Text="Không đơn"></asp:ListItem>
                                                </asp:DropDownList>
                                            </div>
                                        </div>
                                    </div>
