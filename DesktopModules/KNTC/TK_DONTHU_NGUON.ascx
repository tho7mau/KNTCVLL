<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TK_DONTHU_NGUON.ascx.cs" Inherits="KNTC.TK_DONTHU_NGUON" %>
            ...
            <div class="container-fluid">
                <div class="card card-table-master">
                    <div class="card-header sticky">
                        <h3 class="card-title">Thống kê đơn thư theo nguồn</h3>
                        ...
                        <div class="card-body p-0">
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="form-group row">
                                            <label class="col-lg-4 col-form-label">Nguồn đơn</label>
                                            <div class="col-lg-8">
                                                <asp:DropDownList ID="ddlistNguonDon" AutoPostBack="true" runat="server" CssClass="form-control select2bs4">
