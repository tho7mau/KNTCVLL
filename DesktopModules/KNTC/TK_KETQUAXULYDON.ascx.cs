...
namespace KNTC
{
    public partial class TK_KETQUAXULYDON : DotNetNuke.Entities.Modules.UserModuleBase
    {
            ...
            if (Page.IsValid)
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        Byte[] fileBytes = baoCaoController.KQ_XULYDON(vTuNgay, vDenNgay,lblKyBaoCao.Text);
                        if (fileBytes != null)
                        {
                            Response.Clear();
                            Response.Buffer = true;
                            Response.AddHeader("content-disposition", "attachment;filename=" + "TK_BM01_XLD_" + DateTime.Now.Day + "_" + DateTime.Now.Month + "_"
