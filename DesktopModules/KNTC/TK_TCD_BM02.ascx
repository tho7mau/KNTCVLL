<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TK_TCD_BM02.ascx.cs" Inherits="KNTC.TK_TCD_BM02" %>
            ...
            <div class="container-fluid">
                <div class="card card-table-master">
                    <div class="card-header sticky">
                        <h3 class="card-title">Thống kê kết quả phân loại, xử lý đơn qua tiếp công dân</h3>
