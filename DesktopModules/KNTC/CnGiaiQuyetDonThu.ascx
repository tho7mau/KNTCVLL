<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CnGiaiQuyetDonThu.ascx.cs" Inherits="KNTC.CnGiaiQuyetDonThu" %>
...
<div class="modal" id="modal-default-hosoketqua" data-backdrop="static">
    <div class="modal-dialog" style="width: 60%; max-width: 60%;">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Thêm hồ sơ đính kèm kết quả giải quyết</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Always">
                    <ContentTemplate>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="label19">Chọn tập tin </label>
                                    <div class="col-lg-9">
                                        <asp:FileUpload runat="server" ID="fileKetQuaGiaiQuyet" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="label20">Tên hồ sơ </label>
                                    <div class="col-lg-9">
                                        <asp:TextBox ID="textTenHoSoKetQuaGiaiQuyet" runat="server" CssClass="form-control float-left requirement" MaxLength="500" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="label21">Loại hồ sơ </label>
                                    <div class="col-lg-9">
                                        <asp:DropDownList ID="ddlistLoaiHoSoKetQua" runat="server" CssClass="form-control select2bs4">
                                            <asp:ListItem Value="" Text="Chọn loại hồ sơ"></asp:ListItem>
                                            <asp:ListItem Value="1" Text="Đơn kiến nghị, phản ánh"></asp:ListItem>
                                            <asp:ListItem Value="2" Text="Phiếu chuyển đơn"></asp:ListItem>
                                            <asp:ListItem Value="3" Text="Đơn tố cáo"></asp:ListItem>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="form-group row">
                                    <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="label22">Nội dung tóm tắt </label>
                                    <div class="col-lg-9">
                                        <asp:TextBox ID="textNoiDungTomTatKetQua" TextMode="MultiLine" Rows="3" runat="server" CssClass="form-control float-left" MaxLength="500" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="form-tools mr-b10 text-center">
                            <asp:LinkButton ID="buttonLuuHoSoKetQua" OnClick="LuuHoSoKetQuaGiaiQuyet" runat="server" CssClass="btn  bg-gradient-primary btn-flat tool-left"><i class="icofont-plus"></i>  Lưu</asp:LinkButton>
                            <button class="btn  btn-flat btn-md btn-outline-danger tool-left" causesvalidation="false" data-dismiss="modal"><i class="icofont-ui-close"></i>Đóng</button>
                        </div>
                    </ContentTemplate>
                    <Triggers>
                        <asp:PostBackTrigger ControlID="buttonLuuHoSoKetQua" />
                    </Triggers>
                </asp:UpdatePanel>
            </div>
        </div>
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <asp:LinkButton ID="btnBreadcrumbBack" runat="server" OnClick="btnBreadcrumbBack_Click">Giải quyết đơn thư</asp:LinkButton>
                                    </a></li>
                                    ...
                                    <div class="card-body">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6 text-right">
                                                <h1 class="mr-b0"><b>
                                                    <asp:Label runat="server" ID="lblSTT_ThoiHanGiaiQuyet" CssClass="text-primary"> </asp:Label></b></h1>
                                                <span class="text-primary">Thời hạn xử lý đến ngày</span><br />
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <asp:TextBox type="text" class="form-control requirement" ID="textSoNguoi" data-mask runat="server" placeholder="" data-inputmask="'mask': '[9]'" inputmode="numeric" AutoPostBack="true" OnTextChanged="textSoNguoi_TextChanged"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <asp:TextBox type="text" class="form-control requirement" ID="textSoNguoiDaiDien" data-mask runat="server" placeholder="" data-inputmask="'mask': '[9]'" inputmode="numeric" AutoPostBack="true" OnTextChanged="textSoNguoi_TextChanged"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-5">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <div class='input-group datecontrol date reservationdateThoiHanGiaiQuyet' data-target-input="nearest">
                                                                <asp:TextBox Style="width: 50% !important" ID="textThoiHanGiaiQuyet" runat="server" CssClass="form-control datetimepicker-input requirement" placeholder="" />
