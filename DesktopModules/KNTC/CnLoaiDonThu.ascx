<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CnLoaiDonThu.ascx.cs" Inherits="KNTC.CnLoaiDonThu" %>
                ...
                <section class="content-header sticky">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a runat="server" id="linkBackToList" onserverclick="btnBoQua_Click">Quản lý loại đơn thư</a></li>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <asp:TextBox ID="textMoTaLoaiDonThu" runat="server" TextMode="MultiLine" Rows="3" CssClass="form-control float-left" MaxLength="500" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
