<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CnDanToc.ascx.cs" Inherits="KNTC.CnDanToc" %>
                ...
                <section class="content-header sticky">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a runat="server" id="linkBackToList" onserverclick="btnBoQua_Click">Quản lý dân tộc</a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label" runat="server" id="labelTenDanToc">Tên dân tộc</label>
                                                    <div class="col-lg-9">
                                                        <asp:TextBox ID="textTenDanToc" runat="server" CssClass="form-control requirement float-left" MaxLength="500" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
