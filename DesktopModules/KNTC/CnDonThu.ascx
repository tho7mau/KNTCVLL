<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CnDonThu.ascx.cs" Inherits="KNTC.CnDonThu" %>
...
<script type="text/javascript">    
    ...
    function hideModal() {
        // alert("aaaa");
        $('#modal-default-hosodonthu').modal('hide');
        $('#modal-default-hosohuongxuly').modal('hide');
        $('#modal-default-doituong').modal('hide');
        $('#modal-default-hosonguoidaidienuyquyen').modal('hide');
    }
...
<asp:UpdatePanel ID="upn" runat="server" UpdateMode="Always">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item">
                                    <asp:LinkButton ID="btnBreadcrumbBack" runat="server" OnClick="btnBreadcrumbBack_Click">Quản lý đơn thư</asp:LinkButton>
                                    </a></li>
                                ...
                                <div class="form-horizontal">
                                    <div class="card-body">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group row">
                                                    <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="labelNguonDon">Nguồn</label>
                                                    <div class="col-lg-9">
                                                        <asp:DropDownList ID="ddlistNguon" runat="server" CssClass="form-control select2bs4 requirement" OnSelectedIndexChanged="ChonNguonDon" AutoPostBack="True">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group row">
                                                    <label for="inputPhone" class="col-lg-3 col-form-label">Ngày đề đơn</label>
                                                    <div class="col-lg-9">
                                                        <div class='input-group datecontrol date reservationdateNgayNhanVBChuyen' data-target-input="nearest">
                                                            <asp:TextBox ID="textNgayDeDon" runat="server" CssClass="form-control datetimepicker-input requirement" placeholder="" />
                                                            <div class="input-group-append" data-target='.reservationdateNgayNhanVBChuyen' data-toggle="datetimepicker">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group row">
                                                    <label for="inputPhone" class="col-lg-3 col-form-label">Ngày nhận đơn</label>
                                                    <div class="col-lg-9">
                                                        <div class='input-group datecontrol date reservationdateNgayDeDon' data-target-input="nearest">
                                                            <asp:TextBox ID="textNgayNhanDon" runat="server" CssClass="form-control datetimepicker-input requirement" placeholder="" />
                                                            <div class="input-group-append" data-target='.reservationdateNgayDeDon' data-toggle="datetimepicker">
                                                                <div class="input-group-text"><i class="icofont-ui-calendar h5 mb-0"></i></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div runat="server" id="divCoQuanChuyenDon" visible="false">
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="labelCoQuanDaChuyen">Cơ quan đã chuyển</label>
                                                        <div class="col-lg-9">
                                                            <asp:DropDownList ID="ddlistCoQuanDaChuyen" runat="server" CssClass="form-control select2bs4 requirement" AutoPostBack="true">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="labelNgayChuyen">Ngày chuyển</label>
                                                        <div class="col-lg-9">
                                                            <div class='input-group datecontrol date reservationdateNgayChuyen_NguonDon' data-target-input="nearest">
                                                                <asp:TextBox ID="textNgayChuyen" runat="server" CssClass="form-control datetimepicker-input requirement" placeholder="" />
                                                                <div class="input-group-append" data-target='.reservationdateNgayChuyen_NguonDon' data-toggle="datetimepicker">
                                                                    <div class="input-group-text"><i class="icofont-ui-calendar h5 mb-0"></i></div>
                                                                </div>
                                                            </div>
                                                        </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="labelSoVanBanChuyen">Số văn bản chuyển</label>
                                                        <div class="col-lg-9">
                                                            <asp:TextBox ID="textSoVanBanChuyen" runat="server" CssClass="form-control float-left requirement" MaxLength="500" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                        ...
                                        <div class="row" style="padding-top: 15px">
                                            ...
                                            <div class="col-lg-6 text-right">
                                                <h1><b>
                                                    <asp:Label runat="server" ID="labelThongTinDoiTuong" CssClass="text-primary"> </asp:Label></b></h1>
                                                <%--<h6><asp:Label runat="server" ID="lblNgayTiepDan" CssClass="text-primary"> </asp:Label></h6>--%>
                                            </div>
                                        </div>
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <asp:HiddenField runat="server" ID="hdfieldLayThongTin" />
                                                <asp:HiddenField runat="server" ID="hdfieldDoiTuongId" />
                                                <div class="form-group row">
                                                    <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="labelDoiTuong">Đối tượng</label>
                                                    <div class="col-lg-9">
                                                        <asp:DropDownList ID="ddlistDoiTuong" runat="server" CssClass="form-control select2bs4 float-left requirement" AutoPostBack="true" OnSelectedIndexChanged="ChonDoiTuong">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group row" runat="server" id="divNacDanh" visible="false">
                                                    <label for="inputPhone" class="col-lg-3 col-form-label"></label>
                                                    <div class="col-lg-9">
                                                        <asp:CheckBox runat="server" ID="cboxDonThuNacDanh" CssClass="cbCustom" OnCheckedChanged="cboxDonThuNacDanh_ServerChange" AutoPostBack="true" Text="Đơn thư nặc danh" />
                                                        <%--<div class="custom-control custom-checkbox">
                                                            <input class="custom-control-input" type="checkbox" id="" runat="server"  onserverchange="cboxDonThuNacDanh_ServerChange" AutoPostBack="True" ClientIDMode="AutoID"/>
                                                            <label for="<%=cboxDonThuNacDanh.ClientID %>" class="custom-control-label">Đơn thư nặc danh</label>
                                                        </div>--%>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group row">
                                                    <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="labelSoNguoi">Số người</label>
                                                    <div class="col-lg-3">
                                                        <asp:TextBox type="text" class="form-control requirement" ID="textSoNguoi" data-mask runat="server" placeholder="" data-inputmask="'mask':'[9][9]'" inputmode="numeric" AutoPostBack="true" OnTextChanged="textSoNguoi_TextChanged"></asp:TextBox>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group row">
                                                    <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="labelSoNguoiDaiDien">Số người đại diện</label>
                                                    <div class="col-lg-3">
                                                        <asp:TextBox type="text" class="form-control requirement" ID="textSoNguoiDaiDien" data-mask runat="server" placeholder="" data-inputmask="'mask': '[9][9]'" inputmode="numeric" AutoPostBack="true" OnTextChanged="textSoNguoi_TextChanged"></asp:TextBox>
                                                    </div>
                                                    <div class="col-lg-5">
                                        ...
                                        <div class="row" id="divDoiTuong" runat="server" visible="false">
                                            <div class="col-lg-6">
                                                <div class="form-group row">
                                                    <label for="inputPhone" class="col-lg-3 col-form-label">Tên cơ quan, tổ chức</label>
                                                    <div class="col-lg-9">
                                                        <asp:TextBox ID="textTenCoQuanToChuc" runat="server" CssClass="form-control requirement float-left" MaxLength="500" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <asp:TextBox ID="textDiaChi" runat="server" CssClass="form-control  float-left" MaxLength="500" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <asp:ListView runat="server" ID="ListViewDoiTuong" OnItemCreated="ListViewDoiTuong_ItemCreated" DataKeyNames="">
                                            <ItemTemplate>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group row">
                                                            <label for="inputPhone" class="col-lg-3 col-form-label">Họ tên</label>
                                                            <div class="col-lg-9">
                                                                ...
                                                                <asp:TextBox ID="txtCaNhanID" runat="server" Visible="false" CssClass="form-control requirement float-left" MaxLength="500" Text='<%# Eval("CANHAN_ID").ToString() %>' />
                                                                <%--<asp:LinkButton ID="btnChonNguoiDaiDien" runat="server" CssClass="btn btn-sm  btn-flat text-primary float-left"><i class="icofont-maximize h4"></i></asp:LinkButton>--%>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-3">
                                                                <a onserverclick="Xoa_CaNhan_ServerClick" id="Xoa_CaNhan" href='<%# Eval("CANHAN_ID").ToString() %>' visible="false" oncontextmenu="return false" runat="server">Xóa</a>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row" runat="server" id="divDonThuKhongDuDieuKien" autopostback="true">
                                            <div class="col-lg-6">
                                                <div class="form-group row">
                                                    <label for="inputPhone" class="col-lg-3 col-form-label"></label>
                                                    <div class="col-lg-9">
                                                        ...
                                                        <%--  <div class="custom-control custom-checkbox">
                                                            <input class="custom-control-input" type="checkbox" id="cboxDonThuKhongDuDieuKien" runat="server" value="true" />
                                                            <label for="<%=cboxDonThuKhongDuDieuKien.ClientID %>" class="custom-control-label">Đơn thư không đủ điều kiện</label>
                                                        </div>--%>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <%-- <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <asp:DropDownList ID="ddlistDonCu" runat="server" CssClass="form-control select2bs4 requirement" AutoPostBack="true">
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group row">
                                                    <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="labelLoaiDonThu">Loại đơn thư</label>
                                                    <div class="col-lg-9">
                                                        <asp:DropDownList ID="ddlistLoaDonThu" runat="server" CssClass="form-control select2bs4 requirement" OnSelectedIndexChanged="drlLoaiKieuNai_SelectedIndexChanged" AutoPostBack="true">
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <asp:DropDownList ID="ddlistLoaiKhieuNai" runat="server" CssClass="form-control select2bs4" OnSelectedIndexChanged="drlLoaiKieuNai_SelectedIndexChanged" AutoPostBack="true">
                                                        </asp:DropDownList>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                         ...
                                         <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="labelNoiDungDonThu">Nội dung đơn thư</label>
                                                        <div class="col-lg-9">
                                        ...
                                        <div id="donthu_nhieunoidung" runat="server" visible="false">
                                              <div class="row" style="padding-top: 15px">
                                            <div class="col-lg-6">
                                                <h4>Thêm nội dung đơn thư</h4>
                                            </div>                                           
                                        </div>
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="label17">Nội dung đơn thư</label>
                                                        <div class="col-lg-9">

                                                            <asp:TextBox ID="txtNhieuNoiDung" runat="server" CssClass="form-control requirement" TextMode="MultiLine" Rows="5">
                                                            </asp:TextBox>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        <label for="inputPhone" class="col-lg-3 col-form-label">Cơ quan có thẩm quyền</label>
                                                        <div class="col-lg-9">
                                                            <asp:DropDownList ID="drpCoQuanThamQuyen" runat="server" CssClass="form-control requirement select2bs4">
                                                            </asp:DropDownList>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="row">
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <asp:LinkButton runat="server" CausesValidation="false" ID="btnThemNoiDung" OnClick="btnThemNoiDung_Click" CssClass="btn bg-gradient-primary btn-flat tool-left"><i class="icofont-plus"></i>  Thêm nội dung</asp:LinkButton>
                                                        </div>
                                                    </div>
                                            </div>
                                            </div>
                                        ...
                                        <div class="row text-center">
                                            <div class="col-lg-9" style="margin-left: auto; margin-right: auto;">
                                                <asp:DataGrid runat="server" ID="dgNhieuNoiDung" AutoGenerateColumns="False" CssClass="table vertical-align-middle">
                                                    <HeaderStyle CssClass="table-header" />
                                                    <Columns>
                                                        <asp:BoundColumn HeaderText="ID" DataField="ID" Visible="false"></asp:BoundColumn>
                                                        <asp:BoundColumn HeaderText="Nội dung" HeaderStyle-HorizontalAlign="Left" DataField="NOIDUNG" ItemStyle-HorizontalAlign="Left" ItemStyle-Width="60%" HeaderStyle-Width="60%"></asp:BoundColumn>
                                                        <asp:BoundColumn HeaderText="Cơ quan có thẩm quyền" HeaderStyle-HorizontalAlign="Left" DataField="TENDONVI" ItemStyle-HorizontalAlign="Left"></asp:BoundColumn>

                                                        <asp:TemplateColumn HeaderText="Xóa" Visible="true">
                                                            <HeaderStyle Width="10%" HorizontalAlign="Center" />
                                                            <ItemStyle Width="10%" HorizontalAlign="Center" />
                                                            <ItemTemplate>
                                                                <a onserverclick="XoaNoiDung" title="Xóa nội dung" class="icon-xoa" onclick="return getConfirmation(this, 'THÔNG BÁO','Bạn muốn xóa nội dung này?');" href='<%# Eval("ID").ToString()%>' oncontextmenu="return false" runat="server">
                                                                    <i class="icofont-ui-delete"></i>
                                                                </a>
                                                            </ItemTemplate>
                                                        </asp:TemplateColumn>
                                        ...
                                        <div id="donthu_motnoidung" runat="server">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            ...
                                                            <%--<div class="custom-control custom-checkbox">
                                                            <input class="custom-control-input" type="checkbox" id="cbCoQuanDaGiaiQuyet" runat="server" value="true" />
                                                            <label for="<%=cbCoQuanDaGiaiQuyet.ClientID %>" class="custom-control-label">Thông tin cơ quan đã giải quyết</label>
                                                        </div>--%>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div runat="server" id="divCoQuanDaGiaiQuyet" visible="false">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group row">
                                                            <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="labelCoQuanDaGiaiQuyet">Cơ quan đã giải quyết</label>
                                                            <div class="col-lg-9">
                                                                <asp:DropDownList ID="ddlistCoQuanDaGiaiQuyet" runat="server" CssClass="form-control select2bs4 requirement" OnSelectedIndexChanged="drlLoaiKieuNai_SelectedIndexChanged" AutoPostBack="true">
                                                                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group row">
                                                            <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="labelLanGiaiQuyet">Lần giải quyết</label>
                                                            <div class="col-lg-9">
                                                                <asp:TextBox ID="textLanGiaiQuyet" runat="server" CssClass="form-control requirement" Style="width: 40% !important" AutoPostBack="true">
                                                                </asp:TextBox>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group row">
                                                            <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="labelngayBanHanhQuyetDinh">Ngày ban hành quyết định</label>
                                                            <div class="col-lg-9">
                                                                <div class='input-group datecontrol date reservationdateNgayBanHanhQD' data-target-input="nearest">
                                                                    <asp:TextBox ID="textNgayBanHanhQuyetDinh" runat="server" CssClass="form-control datetimepicker-input requirement" placeholder="" />
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group row">
                                                            <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="labelHinhThucGiaiQuyet">Hình thức giải quyết</label>
                                                            <div class="col-lg-9">
                                                                <asp:DropDownList ID="ddlistHinhThucGiaiQuyet" runat="server" CssClass="form-control select2bs4 requirement" AutoPostBack="true">
                                                                ...
                                                                <asp:ListItem Value="3" Text="Quyết định lần 2"></asp:ListItem>
                                                                <asp:ListItem Value="4" Text="Quyết định cuối cùng"></asp:ListItem>
                                                                <asp:ListItem Value="5" Text="Bản án Sơ thẩm"></asp:ListItem>
                                                                <asp:ListItem Value="6" Text="Bản án Phúc thẩm"></asp:ListItem>
                                                                <asp:ListItem Value="7" Text="Bản án Tái thẩm"></asp:ListItem>
                                                                <asp:ListItem Value="8" Text="Quyết định giám đốc thẩm"></asp:ListItem>
                                                                <asp:ListItem Value="9" Text="Trả lời bằng văn bản"></asp:ListItem>
                                                                <asp:ListItem Value="10" Text="Kết luận, thông báo, báo cáo"></asp:ListItem>--%>
                                                                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group row">
                                                            <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="labelKetQuaCuaCoQuanDaGiaiQuyet">Kết quả của cơ quan giải quyết</label>
                                                            <div class="col-lg-9">
                                                                <asp:TextBox ID="textKetQuaCuaCoQuanGiaiQuyet" runat="server" CssClass="form-control requirement" TextMode="MultiLine" Rows="4">
                                                                </asp:TextBox>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            ...
                                                            <%-- <div class="custom-control custom-checkbox">
                                                            <input class="custom-control-input" type="checkbox" id="cbBoSungThongTinNguoiBiKhieuNaiToCao" runat="server" value="true" />
                                                            <label for="<%=cbBoSungThongTinNguoiBiKhieuNaiToCao.ClientID %>" class="custom-control-label">Bổ sung thông tin người bị khiếu nại; tố cáo </label>
                                                        </div>--%>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div runat="server" id="divThongTinNguoiBiKhieuNaiToCao" visible="false">
                                                ...
                                                <div class="row" runat="server" id="divTenCoQuanBiKhieuNaiToCao" visible="false">
                                                    <div class="col-lg-6">
                                                        <div class="form-group row">
                                                            <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="labelTenCoQuanToChuc">Tên cơ quan/tổ chức</label>
                                                            <div class="col-lg-9">
                                                ...
                                                <div runat="server" id="divTenCaNhan_BiKhieuNaiToCao">
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group row">
                                                                <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="labelHoTenNguoiBiKhieuNaiToCao">Họ tên</label>
                                                                <div class="col-lg-9">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group row">
                                                            <label for="inputPhone" class="col-lg-3 col-form-label">Địa chỉ</label>
                                                            <div class="col-lg-9">
                                                                <asp:TextBox ID="textDiaChiDoiTuongBiKhieuNaiToCao" runat="server" CssClass="form-control">
                                                                </asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            ...
                                                            <%-- <div class="custom-control custom-checkbox">
                                                            <input class="custom-control-input" type="checkbox" id="Checkbox1" runat="server" value="true" />
                                                            <label for="<%=cbBoSungThongTinNguoiBiKhieuNaiToCao.ClientID %>" class="custom-control-label">Bổ sung thông tin người đại diện, ủy quyền</label>
                                                        </div>--%>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div runat="server" id="divThongTinNguoiDaiDienUyQuyen" visible="false">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group row">
                                                            <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="labelHoTenNguoiDaiDienUyQuyen">Họ tên</label>
                                                            <div class="col-lg-9">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="form-group row">
                                                        <label for="inputPhone" class="col-lg-3 col-form-label">Tệp đính kèm</label>
                                                        <div class="col-lg-9">
                                                            <asp:FileUpload runat="server" ID="fileNguoiDaiDienUyQuyen" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>--%>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <asp:DropDownList ID="ddlistHuongXuLy" runat="server" CssClass="form-control select2bs4 requirement" AutoPostBack="true" OnSelectedIndexChanged="ChonHuongXuLy" ClientIDMode="AutoID">
                                                    ...
                                                    <div class="col-lg-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <asp:DropDownList ID="ddlistThamQuyenGiaiQuyet" runat="server" CssClass="form-control select2bs4 requirement">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-lg-6">
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-lg-9">
                                                                    <asp:DropDownList ID="ddlistCoQuanTiepNhan" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlistCoQuanTiepNhan_SelectedIndexChanged" CssClass="form-control select2bs4">
                                                                    </asp:DropDownList>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <asp:DropDownList ID="ddlistNguoiDuyet" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ChonNguoiDuyet" CssClass="form-control select2bs4">
                                                                </asp:DropDownList>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6">
                                                        <div class="form-group row">
                                                            <label for="inputPhone" class="col-lg-3 col-form-label">Chức vụ</label>
                                                            <div class="col-lg-9">
                                                                <asp:TextBox ID="textChucVu_HuongXuLy" runat="server" Enabled="false" CssClass="form-control">
                                                                </asp:TextBox>
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <asp:Panel runat="server" ID="pnlYKienXuLy" Visible="false">
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group row">
                                                            <label for="inputPhone" class="col-lg-3 col-form-label" runat="server" id="labelYKienXuLy">Ý kiến xử lý</label>
                                                            <div class="col-lg-9">
    ...
    <Triggers>
        <asp:PostBackTrigger ControlID="btn_XuatPhieu" />
        <asp:PostBackTrigger ControlID="btn_XuatBienNhan" />
    </Triggers>
</asp:UpdatePanel>
<style>
