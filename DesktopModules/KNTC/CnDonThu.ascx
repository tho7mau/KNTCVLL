                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <asp:DropDownList ID="ddlistHuongXuLy" runat="server" CssClass="form-control select2bs4" AutoPostBack="true" OnSelectedIndexChanged="ChonHuongXuLy" ClientIDMode="AutoID">
