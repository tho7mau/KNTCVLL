<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TK_TCD_BM01.ascx.cs" Inherits="KNTC.TK_TCD_BM01" %>
            ...
            <div class="container-fluid">
                <div class="card card-table-master">
                    <div class="card-header sticky">
                        <h3 class="card-title">Thống kê kết quả tiếp công dân thường xuyên, định kỳ và đột xuất</h3>
