<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CnDonVi.ascx.cs" Inherits="KNTC.CnDonVi" %>
                ...
                <section class="content-header sticky">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a runat="server" id="linkBackToList" onserverclick="btnBoQua_Click">Quản lý đơn vị</a></li>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label" runat="server" id="labelTenDonVi">Tên đơn vị</label>
                                                    <div class="col-lg-9">
                                                        <asp:TextBox ID="textTenDonVi" runat="server" CssClass="form-control requirement float-left" MaxLength="500" />
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-lg-3 col-form-label" runat="server" id="labelTenVietTat">Tên viết tắt</label>
                                                    <div class="col-lg-9">
                                                        <asp:TextBox ID="textTenVietTat" runat="server" CssClass="form-control requirement float-left" MaxLength="500" />
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-9">
                                                        <asp:TextBox ID="textMoTaDonVi" runat="server" TextMode="MultiLine" Rows="3" CssClass="form-control float-left" MaxLength="500" />
                                                    </div>
                                                </div>                                                
                                            </div>
                                        </div>
