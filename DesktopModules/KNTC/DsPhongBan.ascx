<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DsPhongBan.ascx.cs" Inherits="KNTC.DsPhongBan" %>
                    ...
                    <div class="card card-table-master">
                                                ...
                                                <ul class="navbar-nav">
                                                    <li class="nav-item dropdown dropdown-filter">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right" role="menu" style="">
                                                            <a href="#" class="dropdown-item" data-option="PHONGBAN.TENPHONGBAN" data-type="normal" data-title="Mã đơn vị"><i class="icofont-check"></i>Tên phòng ban</a>
                                                            <a href="#" class="dropdown-item" data-option="PHONGBAN.TENDONVI" data-type="normal"><i class="icofont-check"></i>Tên đơn vị</a>                                                            
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="table-content p-0">
                                <asp:DataGrid DataKeyField="PB_ID" runat="server" ID="dgDanhSach" AutoGenerateColumns="False" BorderWidth="0" AutoPostback="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn HeaderText="PB_ID" DataField="PB_ID" Visible="false" HeaderStyle-CssClass="sticky">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle />
                                        </asp:BoundColumn>
                                        <asp:TemplateColumn HeaderText="Tên phòng ban" ItemStyle-Width="50%" HeaderStyle-HorizontalAlign="Left" SortExpression="TENPHONGBAN" HeaderStyle-CssClass="sticky">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <a onserverclick="dgDanhSach_Sua" title="Cập nhật đơn vị" href='<%# Eval("PB_ID").ToString() %>' oncontextmenu="return false" runat="server"><%# DataBinder.Eval(Container, "DataItem.TENPHONGBAN") %></a>
                                            </ItemTemplate>
                                        </asp:TemplateColumn> 
                                        <asp:TemplateColumn HeaderText="Tên đơn vị" ItemStyle-Width="15%" HeaderStyle-HorizontalAlign="Left" HeaderStyle-CssClass="sticky">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <%# Eval("TENDONVI") %>
                                            </ItemTemplate>
