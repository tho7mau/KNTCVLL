<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DsNguoiDung.ascx.cs" Inherits="KNTC.DsNguoiDung" %>
                    ...
                    <div class="card card-table-master">
                                                ...
                                                <ul class="navbar-nav">
                                                    <li class="nav-item dropdown dropdown-filter">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right" role="menu" style="">
                                                            <a href="#" class="dropdown-item" data-option="CANBO.Username" data-type="normal" data-title="Tên đăng nhập"><i class="icofont-check"></i>Tên đăng nhập</a>
                                                            <a href="#" class="dropdown-item" data-option="CANBO.CANBO_TEN" data-type="normal" data-title="Tên cán bộ"><i class="icofont-check"></i>Tên cán bộ</a>
                                                            <a href="#" class="dropdown-item" data-option="CANBO.CANBO_EMAIL" data-type="normal" data-title="Email"><i class="icofont-check"></i>Email</a>
                                                            <a href="#" class="dropdown-item" data-option="CANBO.CANBO_SODIENTHOAI" data-type="normal"><i class="icofont-check"></i>Số điện thoại</a>
                                                        </div>
                                                    </li>
                                                </ul>
                                            </div>
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="table-content p-0">
                                <asp:DataGrid DataKeyField="CANBO_ID" runat="server" ID="dgDanhSach" AutoGenerateColumns="False" BorderWidth="0" AutoPostback="True"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundColumn HeaderText="CANBO_ID" DataField="CANBO_ID" Visible="false" HeaderStyle-CssClass="sticky">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <HeaderStyle />
                                        </asp:BoundColumn>

                                        <asp:TemplateColumn HeaderText="Tên đăng nhập" HeaderStyle-HorizontalAlign="Left" SortExpression="Username" HeaderStyle-CssClass="sticky">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <%# Eval("Username") %>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                        <asp:TemplateColumn HeaderText="Tên cán bộ" ItemStyle-Width="30%" HeaderStyle-HorizontalAlign="Left" SortExpression="CANBO_TEN" HeaderStyle-CssClass="sticky">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <a onserverclick="dgDanhSach_Sua" title="Cập nhật đơn vị" href='<%# Eval("CANBO_ID").ToString() %>' oncontextmenu="return false" runat="server"><%# DataBinder.Eval(Container, "DataItem.CANBO_TEN") %></a>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>

                                        <asp:TemplateColumn HeaderText="Email" ItemStyle-Width="15%" HeaderStyle-HorizontalAlign="Left" SortExpression="CANBO_EMAIL" HeaderStyle-CssClass="sticky">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <%# Eval("CANBO_EMAIL") %>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                        <asp:TemplateColumn HeaderText="Số điện thoại" ItemStyle-Width="15%" HeaderStyle-HorizontalAlign="Left" HeaderStyle-CssClass="sticky">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <%# Eval("CANBO_SODIENTHOAI") %>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                        <asp:TemplateColumn HeaderText="Ghi chú" ItemStyle-Width="15%" HeaderStyle-HorizontalAlign="Left" HeaderStyle-CssClass="sticky">
                                            <ItemStyle HorizontalAlign="Left" />
                                            <ItemTemplate>
                                                <%# Eval("GHICHU") %>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>
                                        <asp:TemplateColumn HeaderText="Lãnh đạo" ItemStyle-Width="8%" HeaderStyle-HorizontalAlign="Center" HeaderStyle-CssClass="sticky">
                                            <ItemStyle HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <a id="lnkKichHoat" href='<%# DataBinder.Eval(Container,"DataItem.CANBO_ID") %>' onserverclick="ThayDoiTrangThai" runat="server">
                                                    <%#(DataBinder.Eval(Container,"DataItem.LANHDAO").ToString().Equals("True"))?"<i class='icofont-check-circled' style='color:#008000; font-size:18px'></i>":"<i class='icofont-close-circled' style='color:red;font-size:18px'></i>" %>                                                         
                                                </a>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>

                                        <asp:TemplateColumn HeaderText="Đổi mật khẩu" ItemStyle-Width="8%" HeaderStyle-HorizontalAlign="Left" HeaderStyle-CssClass="sticky">
                                            <ItemStyle HorizontalAlign="Center" />
                                            <ItemTemplate>
                                                <a onserverclick="DoiMatKhau" title="Đổi mật khẩu người dùng" href='<%# Eval("CANBO_ID").ToString() %>' oncontextmenu="return false" runat="server"><i class="icofont-ui-password fz18"></i></a>
                                            </ItemTemplate>
                                        </asp:TemplateColumn>                                  
                                    </Columns>
