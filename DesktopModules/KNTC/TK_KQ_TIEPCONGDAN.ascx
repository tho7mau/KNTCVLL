<%@ Control Language="C#" AutoEventWireup="true" CodeFile="TK_KQ_TIEPCONGDAN.ascx.cs" Inherits="KNTC.TK_KQ_TIEPCONGDAN" %>
            ...
            <div class="container-fluid">
                <div class="card card-table-master">
                    <div class="card-header sticky">
                        <h3 class="card-title">Thống kê tổng hợp kết quả tiếp công dân</h3>
