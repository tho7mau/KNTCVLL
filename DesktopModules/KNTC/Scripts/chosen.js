(function() {
    ...
    AbstractChosen = (function() {
        ...
        AbstractChosen.prototype.result_add_option = function(option) {
            ...
            if (!option.selected && this.is_multiple) {
                innerHTMLTEXT = '<input type="checkbox" class="checkBox" onclick="checkboxFunction(this); return false;" data-option-array-index="' + option.array_index + '"/>';
            }
            if (option.disabled && !(option.selected && this.is_multiple) || option.classes === "selected1") {
                classes.push("disabled-result");
            }
            if (option.selected) {
                classes.push("result-selected");
            }
            if (option.selected && (option.classes === 'selected1' || option.classes === ' selected1')) {
                var checkedtrue = 'checkedtrue';
                innerHTMLTEXT = '<input type="checkbox" class="checkBox" checked data-checkedtrue="checkedtrue" onclick="checkboxFunction(this); return false;" data-option-array-index="' + option.array_index + '"/>';
            }
            if (option.selected && this.is_multiple && option.classes.indexOf('selected1') < 0) {
                innerHTMLTEXT = '<input type="checkbox" class="checkBox" checked onclick="checkboxFunction(this); return false;" data-option-array-index="' + option.array_index + '"/>';
            }
    ...
    Chosen = (function(_super) {
        ...
        Chosen.prototype.set_up_html = function() {
            ...
            if ($(this.form_field).hasClass('tabfocus')) {
                container_props = {
                    'class': '' + container_classes.join(' ') + ' texttab',
                    'style': "width: " + (this.container_width()) + ";",
                    'title': this.form_field.title
                };
                $(this.form_field).removeClass('tabfocus');
                tabfocus = 'tabfocus';
                tabindex = 1;
            } else {
                container_props = {
            ...
            if (this.is_multiple) {
                if (this.display_selectall_option) {
                    this.container.html('<ul class="chosen-choices"><li class="search-field"><input type="text" value="' + this.default_text + '" class="default" autocomplete="off" style="width:25px;" /></li></ul><div class="chosen-drop"><div class="selectallSection text-right"><span class="pd-r10">Chọn tất cả</span></div><ul class="chosen-results"></ul></div>');
                } else {
                    this.container.html('<ul class="chosen-choices"><li class="search-field"><input type="text" value="' + this.default_text + '" class="default" autocomplete="off" style="width:25px;" /></li></ul><div class="chosen-drop"><ul class="chosen-results"></ul></div>');
                }
            } else {
                this.container.html('<a class="chosen-single ' + tabfocus + ' chosen-default" tabindex="' + tabindex + '" href="#"><span>' + this.default_text + '</span><div><b></b></div></a><div class="chosen-drop"><div class="chosen-search"><input type="text" autocomplete="off" /></div><ul class="chosen-results"></ul></div>');
            }
        ...
        Chosen.prototype.choice_build = function(item) {
            ...
            if (item.classes === "selected1") {
                rejectclass = 'selected1';
            } else {
                rejectclass = '';
            }
            var choice, close_link, _this = this;
            choice = $('<li />', {
                "class": "search-choice " + rejectclass + ""
        ...
        Chosen.prototype.choice_destroy = function(link) {
            ...
            if (this.result_deselect(link[0].getAttribute("data-option-array-index"))) {
                ...
                this.search_field_scale();
                $(this.search_container).children('input').addClass('testingss').click();
            }
        };
                ...
                if (high.hasClass('result-selected') || high.parent('li').hasClass('result-selected')) {
                    ...
                    if (this.result_highlight) {
                        ...
                        if (high[0].type == 'checkbox') {
                            high.addClass("result-selected").parent('li').addClass("result-selected");
        ...
        Chosen.prototype.keydown_arrow = function() {
            ...
            if (this.results_showing && this.result_highlight) {
                next_sib = this.result_highlight.nextAll('li').first();
                if (next_sib) {
        ...
        Chosen.prototype.keyup_arrow = function() {
            ...
            if (!this.results_showing && !this.is_multiple) {
                ...
                prev_sibs = this.result_highlight.prevAll("li");
                if (prev_sibs.length) {
