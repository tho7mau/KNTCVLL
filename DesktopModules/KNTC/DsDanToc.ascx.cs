...
/// Mục đích        :Hiển thị danh sách dân tộc
/// Ngày tạ0        :09/04/2021
...
{
    /// <summary>
    /// Xử lý dữ liệu danh sách dân tộc
    /// </summary>

    public partial class DsDanToc : DotNetNuke.Entities.Modules.UserModuleBase
    {
        #region Properties
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                Get_Cache();
                //Edit Title
                this.ModuleConfiguration.ModuleTitle = "Quản lý dân tộc";
                if (!IsPostBack)
                {
        ...
        protected void dgDanhSach_Sua(object sender, EventArgs e)
        {
            ...
            string vUrl = Globals.NavigateURL("edit", "mid=" + this.ModuleId, "title=Cập nhật thông tin dân tộc", "id=" + vId);
        ...
        protected void btn_Xoa_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    vDanTocController.XoaDanToc(vId, out oErrorMessage);
                    vCountDaXoa += 1;
                }
                ClassCommon.ShowToastr(Page, "Xóa thành công " + vCountDaXoa + " dân tộc!", "Thông báo", "success");
        ...
        protected void LoadDanhSach(int v_start, int v_end)
        {
            try
            {
                ...
                if (vSearchOption == "")
                {
                    vSearchOption = "|DANTOC.DANTOC_TEN,normal,,|DANTOC.DANTOC_MOTA,normal,,";
                }
                DataSet ds = objCommonController.GetPage(PortalId, ModuleId, "DanToc_GetPage", vSearchOption, textSearchContent.Text, vKeySort + " " + vTypeSort, v_start - 1, v_end);
