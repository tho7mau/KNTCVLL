<%@ Control Language="C#" AutoEventWireup="true" CodeFile="CnNguoiDung.ascx.cs" Inherits="HOPKHONGGIAY.CnNguoiDung" %>
                        ...
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <div class="col-sm-6 col-md-6 col-lg-6 pd-l30 pd-r30">
                                ...
                                <div class="form-group mr-t10">
                                    ...
                                    <div class="col-sm-9 col-md-9 col-lg-9">
                                        <asp:TextBox ID="textHoTenNguoiDung" runat="server" CssClass="form-control requirements" MaxLength="200" />
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6 col-md-6 col-lg-6">
                                ...
                                <div class="form-group mr-t10">
                                 ...
                                 <div class="form-group mr-t10">
                                    <label runat="server" id="label1" class="col-sm-3 control-label pd-r0">Quyền quản trị </label>
                                    <div class="col-sm-9 col-md-9 col-lg-9 pd-t5">
                                        <asp:CheckBox ID="checkboxQuyenChuyenVien" runat="server" CssClass="mr-l10"/>
                                    </div>
                                </div>
                            </div>
                        </div>
