<%@ Control Language="C#" AutoEventWireup="true" CodeFile="DsPhongBan_old.ascx.cs" Inherits="HOPKHONGGIAY.DsPhongBan" %>
...
<asp:UpdatePanel runat="server" ID="updatePN">
    <ContentTemplate>
            ...
            <div class="form-inline">
                ...
                <div class="col-left" runat="server">
                    ...
                    <div style="display: none;">
                        <asp:LinkButton ID="btn_Xoa" OnClientClick="return getConfirmation(this, 'THÔNG BÁO','Bạn chắc chắn muốn xóa những phòng ban đã chọn?');" CausesValidation="false" Visible="true" runat="server" CssClass="btn-default btn-sm none-radius  btn min-width-100 mr-t3 mr-b3" OnClick="btn_Xoa_Click"><i class=""></i> Xóa</asp:LinkButton>
                    </div>
                </div>
            </div>
        </asp:Panel>
        ...
        <asp:Panel ID="pnlDanhSach" runat="server" CssClass="danhsach">
            ...
            <asp:DataGrid DataKeyField="PB_ID" runat="server" ID="dgDanhSach" OnInit="dgDanhSach_Init" AutoGenerateColumns="False" OnPageIndexChanged="dgDanhSach_PageIndexChanged" AllowPaging="True" AllowCustomPaging="False" OnItemCreated="dgDanhSach_ItemCreated"
                ...
                <Columns>
                    ...
                    <asp:BoundColumn HeaderText="PB_ID" DataField="PB_ID" Visible="false">
                    ...
                    <%-- <asp:TemplateColumn HeaderText="TT">
                       ...
                       <asp:TemplateColumn HeaderText="Tên phòng ban" HeaderStyle-HorizontalAlign="Left" SortExpression="TenPhongBan">
                        <ItemStyle HorizontalAlign="Left" />
                        <ItemTemplate>
                         <a id="dgChiTiet" onserverclick="dgDanhSach_Sua" title="Cập nhật thông tin phòng ban"  href='<%# Eval("PB_ID").ToString() %>' oncontextmenu="return false" runat="server">   <%# DataBinder.Eval(Container, "DataItem.TENPHONGBAN") %></a>  
                        </ItemTemplate>
                    </asp:TemplateColumn>

                    <asp:TemplateColumn HeaderText="Đơn vị" HeaderStyle-HorizontalAlign="Left">
                        <ItemStyle HorizontalAlign="Left" />
                        <ItemTemplate>
                 ...
                 <%--   <asp:TemplateColumn HeaderText="Trạng thái">
                  ...
                  <%--  <asp:TemplateColumn HeaderText="Sửa" Visible="true">
                        ...
                        <ItemStyle Width="5%" HorizontalAlign="Center" />
                        <ItemTemplate>
                            <a onserverclick="dgDanhSach_Sua" title="Cập nhật thông tin phòng ban" class="icon-sua" href='<%# Eval("PB_ID").ToString() %>' oncontextmenu="return false" runat="server"></a>
                        </ItemTemplate>
                    </asp:TemplateColumn>--%>
                    ...
                    <asp:TemplateColumn HeaderText="Xóa" Visible="false">
                        ...
                        <ItemStyle Width="5%" HorizontalAlign="Center" />
                        <ItemTemplate>
                            <a onserverclick="dgDanhSach_Xoa" title="Xóa phòng ban" class="icon-xoa" onclick="return getConfirmation(this, 'XÓA PHÒNG BAN','Bạn muốn xóa phòng ban này?');" href='<%# Eval("PB_ID").ToString()%>' oncontextmenu="return false" runat="server"></a>
                        </ItemTemplate>
                    </asp:TemplateColumn>
                </Columns>
