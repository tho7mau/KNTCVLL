...
<head id="Head" runat="server" ViewStateMode="Disabled">
    ...
    <title />
    <link id="favicon" rel="SHORTCUT ICON" href="/Portal/0/favicon.ico" type="image/x-icon">
...
<body id="Body" runat="server" class="hold-transition sidebar-mini layout-footer-fixed layout-navbar-fixed layout-fixed">
